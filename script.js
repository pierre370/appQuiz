...
var HTMLquestions=[
    ...
    {
        question: "HTML est quel type de langage ?",
        choices: ["Langage de script","Langage de balisage","Langage de programmation","Protocole réseau"],
        answer: 2

    },

    {
        question: "HTML utilise :\n",
        choices: ["Balises définies par l'utilisateur","Balises pré-spécifiées","Balises fixes définies par la langue","Balises uniquement pour les liens"],
        answer: 3
